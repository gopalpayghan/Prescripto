    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-800">
            ...
            {docSlots.length &&
              docSlots.map((item, index) => (
                <div
                  ...
                  className={`text-center min-w-16 cursor-pointer py-6 rounded-full ${
                    slotIndex === index
          ...
          <div className="flex gap-3 mt-4 items-center w-full overflow-x-scroll">
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                <p
                  className={`text-sm font-light px-5 py-2 flex-shrink-0 cursor-pointer rounded-full ${
                    item.time === slotTime
                      ? "bg-primary text-white"
          ...
          <button className="px-14 py-3 my-6 bg-primary text-white text-sm font-light rounded-full cursor-pointer">
            Book Appointment
          </button>
        </div>
